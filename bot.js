...
client.channels.find('id', '494232642636611586').setName("•");
client.channels.find('id', '494232642636611586').setName("•『");
client.channels.find('id', '494232642636611586').setName("•『 S");
client.channels.find('id', '494232642636611586').setName("•『 Sea");
client.channels.find('id', '494232642636611586').setName("•『 Sea W");
client.channels.find('id', '494232642636611586').setName("•『 Sea Wo");
client.channels.find('id', '494232642636611586').setName("•『 Sea Wor");
client.channels.find('id', '494232642636611586').setName("•『 Sea Worl");
client.channels.find('id', '494232642636611586').setName("•『 Sea World");
client.channels.find('id', '494232642636611586').setName("•『 Sea World 』");
client.channels.find('id', '494232642636611586').setName("•『 Sea World 』🌊");
